...
<body>
    ...
    <section class="hero-section hero-1" style="background-image: url('assets/img/banner1.jpg')">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5 col-sm-12 text-center text-lg-left">
                    <div class="hero-content overflow-hidden">
                        ...
                        <div class="social-profile pb-lg-4">
                            <a href="https://web.facebook.com/fidelis.ukwuani" class="wow fadeInLeft"
                                data-wow-duration="1.2s" data-wow-delay="2.2s"><i class="fal fa-plus"></i>facebook</a>
                            <a href="https://twitter.com/FidelisUkwuani" class="wow fadeInLeft" data-wow-duration="1.2s"
                                data-wow-delay="2.5s"><i class="fal fa-plus"></i>twitter</a>
                            <a href="https://www.linkedin.com/in/ukwuani-fidelis-b271ab1b6/" class="wow fadeInLeft"
                ...
                <div class="col-lg-6 offset-lg-1 col-sm-12 text-center overflow-hidden">
                    <div class="hero-profile-img wow fadeInUp" data-wow-duration="2s" data-wow-delay=".9s">
                        <img src="assets/img/profile.png" alt="Spruce" class="img-fluid" style="width: 100%;">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 offset-lg-1 col-12 wow fadeInRight" data-wow-duration="1.2s" data-wow-delay=".4s">
                    <div class="about-content">
                        ...
                        <p class="mb-2">I build everything with, <strong>Web Apps</strong> (Jquery, Vue Js, Nuxt Js,
                            PHP,
                ...
                <div class="col-lg-6 col-12 mt-5 mt-lg-0">
                    <div class="design-skills">
                        ...
                        <div class="row">
                            ...
                            <div class="single-design-skill text-center col-sm-4 col-12">
                                <div class="circlechart" data-percentage="99"></div>
                                <p>Collaborative</p>
                            </div>
                            <div class="single-design-skill text-center col-sm-4 col-12">
                                <div class="circlechart" data-percentage="95"></div>
                            ...
                            <div class="single-design-skill text-center col-sm-4 col-12">
                                <div class="circlechart" data-percentage="92"></div>
            ...
            <div class="row align-items-center">
                <div class="col-md-8 col-lg-6">
                    <div class="section-title-two text_left">
                        <h2>My Experience</h2>
                        <p>Here are my work experience in the field.</p>
                    </div>
                </div>
    ...
    <section class="portfolio-showcase section-padding " id="portfolio">
        <div class="container">
                ...
                <div class="col-12 text-center col-lg-10 offset-lg-1">
                    <div class="section-title-one">
                        ...
                        <h2>Here are a few past projects I've worked on. <br> <small>Want to see more? <a
                                    href="mailto:ukwuanifidelis2851@gmail.com">Email me</a></small>.</h2>
                    </div>
                </div>
            </div>
            <!-- 
            ...
            <div class="row grid p-0">
                ...
                <div class="col-lg-4 col-md-6 col-12 grid-item projects">
                    <div class="single-portfolio-item">
                        <a href="assets/img/portfolio/escrow_pay1.png" class="popup-gallery">
                            <img class="img-fluid" src="assets/img/portfolio/escrow_pay1.png" alt="">
                            <span class="zoom-icon">+</span>
                        </a>
                    </div>
                    <p class="mt-2">Projects</p>
                ...
                <div class="col-lg-4 col-md-6 col-12 grid-item projects">
                    <div class="single-portfolio-item">
                        <a href="assets/img/portfolio/vestpro-frontend.png" class="popup-gallery">
                ...
                <div class="col-lg-4 col-md-6 col-12 grid-item projects">
                    <div class="single-portfolio-item">
                        <a href="assets/img/portfolio/community management system.jpg" class="popup-gallery">
                            <img class="img-fluid" src="assets/img/portfolio/community management system.jpg" alt="">
                            <span class="zoom-icon">+</span>
                        </a>
                    </div>
                    <p class="mt-2">Projects</p>
                ...
                <div class="col-lg-4 col-md-6 col-12 grid-item projects">
                    <div class="single-portfolio-item">
                        <a href="assets/img/portfolio/escrow_pay2.png" class="popup-gallery">
                            <img class="img-fluid" src="assets/img/portfolio/escrow_pay2.png" alt="">
                            <span class="zoom-icon">+</span>
                        </a>
                    </div>
                    <p class="mt-2">Projects</p>
                    ...
                    <div class="testimonial-box-active text-center owl-carousel owl-theme">
                        <div class="single-testimonial-item">
                            ...
                            <div class="client-info">
                                <h3>Augustine Chima</h3>
                                <span>CEO of Tanatech Labs Ltd</span>
                            </div>
                        ...
                        <div class="single-testimonial-item">
                            ...
                            <div class="client-info">
                                <h3>Ikechukwu Anthony</h3>
                                <span>CEO of Escrow Pay Ltd</span>
                            </div>
                            <p>Working with Fidelis was better than expected and we had really high expectations. He is
                                an incredibly talented developer and what really makes him stand out is his work ethic
                                and steady approach. Time after time, and without us asking, he added enhancements and
                                improvements that resulted in a better end product for us and our customers.</p>
                        </div>
                        <div class="single-testimonial-item">
                            <div class="client-img" style="background-image: url('assets/img/client3.png');"></div>
                            <div class="client-info">
                                <h3>Mmachukwu Loretta</h3>
                                <span>Executive Director of GECCI</span>
                            </div>
                            <p>Fidelis has done a fantastic job overall. Not only the site he designed, the code is
                                very clean and slick. Love the way he achieved the responsive portion of the site.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-12 mt-5 text-center text-lg-left">
                    <div class="section-title-two text_left">
                        <h2>Need To ask any Questions, Call Me or Message me.</h2>
                ...
                <div class="col-12 col-lg-7 offset-lg-1">
                    ...
                    <div class="contact-form-wraper">
                        <form onsubmit="event.preventDefault(); sendMail()" method="post" class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="single-input">
                                    <input type="email" name="reply_to" id="reply_to" placeholder="Enter your Email address"
                                        required>
                                </div>
                            </div>
